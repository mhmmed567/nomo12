      ...
      <div className="mx-auto max-w-7xl px-5 py-5 sm:px-8 lg:px-10">
        ...
        <nav className="sticky top-5 z-50 mx-auto flex max-w-5xl items-center justify-between rounded-2xl border border-black/[0.06] bg-white/75 px-4 py-3 shadow-[0_10px_40px_rgba(16,35,29,0.06)] backdrop-blur-xl">
          ...
          <Link href="/assessment">
            <Button
              radius="lg"
              className="bg-[#123c31] px-5 font-bold text-white shadow-lg shadow-[#123c31]/10"
            >
              ابدأ الآن
            </Button>
          </Link>
          ...
          <div className="relative z-10 grid items-center gap-14 lg:grid-cols-[1.2fr_0.8fr]">
            ...
            <div>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Link href="/assessment">
                  <Button
                    size="lg"
                    radius="lg"
                    className="w-full bg-[#b9e5c5] px-7 font-black text-[#123c31] shadow-xl shadow-black/10 sm:w-auto"
                  >
                    اكتشف مستواك
                    <span>←</span>
                  </Button>
                ...
                <Link href="#features">
                  <Button
                    ...
                    variant="bordered"
                    radius="lg"
                    className="w-full border-white/15 bg-white/[0.05] px-7 font-bold text-white backdrop-blur-md sm:w-auto"
                  >
                    كيف يعمل NOMO؟
                  </Button>
                </Link>
              ...
              <div className="mt-12 flex flex-wrap gap-8 border-t border-white/10 pt-7">
                <Stat value="AI" label="تعلم ذكي" />
                <Stat value="7" label="أيام تعلم" />
                <Stat value="∞" label="إمكانيات" />
              </div>
            </div>
        ...
        <section id="features" className="py-20 md:py-28">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-sm leading-8 text-[#71827b] md:text-base">
              بدل ما تبدأ من مكان عشوائي، NOMO يبدأ بفهم مستواك
              ثم يحول النتيجة إلى تجربة تعلم واضحة.
            </p>
          </div>
          ...
          <div className="relative z-10 flex flex-col items-start justify-between gap-8 md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-3 max-w-xl text-sm leading-7 text-[#71827b]">
                اختبار بسيط يساعد NOMO على فهم مستواك وبناء
                بداية مناسبة لك.
              </p>
            </div>
            ...
            <Link href="/assessment">
              <Button
                size="lg"
                radius="lg"
                className="bg-[#123c31] px-8 font-black text-white shadow-xl shadow-[#123c31]/15"
              >
                ابدأ الاختبار
                <span>←</span>
              </Button>
