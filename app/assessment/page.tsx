  ...
  async function generateQuestions() {
    try {
      ...
      if (
        ...
        throw new Error(
          "لم يتم إنشاء أسئلة صالحة للاختبار."
        );
      }
  ...
  async function finishAssessment() {
    try {
      ...
      try {
        ...
        console.error(text);
        throw new Error(
          "الخادم لم يرجع نتيجة صحيحة."
        );
      }

      if (!response.ok) {
        throw new Error(
          data?.error || "فشل تحليل النتيجة."
        );
      }
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute -right-40 -top-40 h-96 w-96 rounded-full bg-[#b9e5c5]/20 blur-3xl" />
          ...
          <div className="p-5 sm:p-8 lg:p-10">
            ...
            <div className="mt-8 flex flex-col-reverse gap-3 sm:flex-row">
              <Button
                ...
                className="h-14 border border-[#e1e8e4] bg-[#f7f9f7] px-7 font-black text-[#40544b]"
              >
                السابق
              </Button>
              ...
              <Button
                ...
                className="h-14 flex-1 bg-[#123c31] px-7 font-black text-white shadow-lg shadow-[#123c31]/10"
              >
                {isLastQuestion
                  ? "تحليل مستواي"
                  : "السؤال التالي"}
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute right-[10%] top-[15%] h-40 w-40 rounded-full bg-[#b9e5c5]/20 blur-3xl" />
        <div className="absolute bottom-[10%] left-[10%] h-48 w-48 rounded-full bg-[#dff4e6]/30 blur-3xl" />
      </div>
    ...
    >
      <div className="relative w-full max-w-md">
        <div className="nomo-card p-8 text-center sm:p-10">
          <div className="mx-auto grid h-16 w-16 place-items-center rounded-2xl bg-[#fcf1f1] text-2xl">
            !
          </div>
          ...
          <Button
            ...
            radius="lg"
            onPress={onRetry}
            className="mt-7 h-14 w-full bg-[#123c31] font-black text-white"
          >
            المحاولة مرة أخرى
          </Button>
        </div>
