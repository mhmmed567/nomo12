        ...
        <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <Link href="/assessment">
            <Button
              color="primary"
              radius="lg"
              className="h-10 bg-[#123c31] px-5 text-xs font-black text-white"
            >
              إعادة التقييم
            </Button>
          </Link>
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            <div className="flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between">
              ...
              <Button
                ...
                className="h-14 shrink-0 bg-[#123c31] px-8 text-sm font-black text-white shadow-xl shadow-[#123c31]/10"
              >
                {creatingPlan
                  ? "جاري بناء الخطة..."
                  : "إنشاء خطة التطوير ✦"}
        ...
        <section className="mt-6 overflow-hidden rounded-[32px] border border-[#dcebe0] bg-[#eff8f1] p-7 text-center sm:rounded-[38px] sm:p-10">
          <div className="mx-auto max-w-2xl">
            ...
            <Button
              ...
              onPress={createPlan}
              isLoading={creatingPlan}
              className="mt-6 h-14 bg-[#123c31] px-8 text-sm font-black text-white"
            >
              ابدأ رحلة التطوير
            </Button>
          </div>
...
function StatCard({
  ...
  return (
    <div className="nomo-card-hover rounded-[25px] border border-[#e1e8e4] bg-white p-5 sm:p-6">
      <div className="flex items-center justify-between">
        <div className="grid h-10 w-10 place-items-center rounded-xl bg-[#eff8f1] text-sm font-black text-[#4d8d60]">
          {icon}
        </div>
...
function InsightCard({
  ...
  return (
    <div className="nomo-card p-6 sm:p-7">
      <div className="flex items-center gap-3">
        <div
...
function DomainCard({
  ...
  return (
    <div className="rounded-[28px] border border-[#e1e8e4] bg-[#fbfcfa] p-5 sm:p-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="text-[9px] font-black text-[#9aa9a3]">
            DOMAIN
          </div>
...
function EmptyItem() {
  return (
    <div className="rounded-2xl bg-[#fbfcfa] p-4 text-sm font-bold text-[#9aa9a3]">
